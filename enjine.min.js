...
Enjine.KeyboardInput = {
  ...
  KeyDownEvent: function (a) {
    this.Pressed[a.keyCode] = true;
    this.PreventScrolling(a);
  },
  KeyUpEvent: function (a) {
    this.Pressed[a.keyCode] = false;
    this.PreventScrolling(a);
  },
...
Enjine.Resources = {
  ...
  PlaySound: function (a, b) {
    ...
    b &&
      this.Sounds[a][this.Sounds[a].index].addEventListener(
        "ended",
        this.LoopCallback,
        !1
      );
...
Enjine.Drawable.prototype = { Draw: function () {} };
...
Enjine.AnimatedSprite.prototype.Update = function (a) {
  if (
    !this.CurrentSequence.SingleFrame &&
    this.Playing &&
    ((this.LastElapsed -= a), !(this.LastElapsed > 0))
  ) {
